    ...
    data.forEach(item => {
        ...
        tr.innerHTML = `
            ...
            <td>${item.fecha_creacion}</td>
             <td>
                <button class="btn btn-danger btn-sm" onclick="eliminarCurso(${item.idCurso})">Eliminar</button>
                <button class="btn btn-primary btn-sm" onclick="editarCurso(${item.idCurso})">Editar</button>
            </td>
        `;
